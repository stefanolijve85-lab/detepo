    ...
    },
    {
      ...
      body:
        data.peakHourCount > 0
          ? t("insight.peak.with", { hour: data.peakHour, count: formatNumber(data.peakHourCount) })
          : t("insight.peak.without"),
    },
    {
      title: t("insight.health.title"),
      body: `${t("insight.health.summary", { online: data.onlineCount, total: data.counters.length })} ${offlinePart}`,
    },
  ];
